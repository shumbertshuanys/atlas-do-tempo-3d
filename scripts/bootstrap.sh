...
# papéis de leitura, migra a carga real (54 itens · 61 claims), e roda as suítes de teste.
...
echo "==> (7/8) instalando deps Python e migrando a carga (54 itens · 61 claims)…"
